...
function buildDiscriminator() {
  ...
  // The probability score assigned by the discriminator to
  ...
  // The softmax probabilities assign by the discriminator for the 10
  // MNIST digit classes (0 through 9). "aux" stands for "auxiliary" (the
  // namesake of ACGAN) and refers to the fact that unlike a standard GAN 
